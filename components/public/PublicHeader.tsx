...
const NAV_LINKS = [
  { href: '#presentation', label: 'L\'ESB', icon: '🏫' },
  { href: '#formations',   label: 'Formations', icon: '📚' },
  { href: '#chiffres',     label: 'Chiffres clés', icon: '📊' },
          ...
          {NAV_LINKS.map((l) => (
            <a
              ...
              className={cn(
                ...
                isScrolledOrDark
                  ? 'text-[#64748B] dark:text-slate-400 hover:text-[#1E3A8A] dark:hover:text-blue-400 hover:bg-slate-100 dark:hover:bg-white/5'
